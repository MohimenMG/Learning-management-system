...
CREATE TABLE Students.Students (
    ...
    student_enrolled_program_id INT REFERENCES Institutions.Programs(program_id),
    student_institution_enrollment_date DATE,
    student_institution_id INT REFERENCES Institutions.Institutions(institution_id)
);
...
CREATE TABLE Institutions.InstitutionPrograms (
    ...
    PRIMARY KEY (program_assignment_date, institution_id, program_id)
);

-- 16-InstitutionsDepartments
